...
> **👉 Primera vez?** Lee [START.md](START.md) para empezar en 3 pasos

Resuelve 3 challenges de algoritmos. Tu tiempo de ejecución será medido automáticamente.
...
# 3. Programar
# Edita los archivos en challenges/challengeX/solution.js
```

## ✅ Probar tu Código

```bash
npm test              # Ver si tus soluciones funcionan
npm run test:time     # Ver tiempos de ejecución
```
...
- ✅ Resuelve en `solution.js` de cada challenge
